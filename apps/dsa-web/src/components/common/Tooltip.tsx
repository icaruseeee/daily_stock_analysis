      ...
      {typeof document !== 'undefined' && open
        ? createPortal(
            <span
              ...
              className={cn(
                'pointer-events-none z-[120] min-w-max max-w-[18rem] rounded-xl border border-divider/70 bg-elevated/95 px-3 py-1.5 text-xs leading-5 text-foreground shadow-[0_16px_40px_rgba(3,8,20,0.18)] backdrop-blur-xl',
